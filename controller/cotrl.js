...
exports.BookCar = async (req, res) => {
    try {
        ...
        await booking.save();
         console.log(booking);
         const rentprice = await carModel.find(booking.carId)
         console.log(rentprice,">>>>>>>>>>>>>>>>>>>>>>>");
        var instance = new Razorpay({ key_id: 'rzp_test_6dQwzWMAy9uqc1', key_secret: 'mGscxR1KrtbuQ2twNFTcsL4HT' })

       const Razorpayid = instance.orders.create({
          amount: rentprice[0]. carRentPerDayPrice*100,
          currency: "INR",
          receipt: "rentcarprice",
        //   notes: {
        //     key1: "value3",
        //     key2: "value2"
        //   }
